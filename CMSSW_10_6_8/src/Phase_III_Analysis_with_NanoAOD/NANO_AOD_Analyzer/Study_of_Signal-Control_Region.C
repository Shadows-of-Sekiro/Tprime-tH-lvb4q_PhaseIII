...
// Event Loop started here and main analyzing code starts ==============================================================================
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
      ...
      // if (ientry > 2000) break;  // Run it to check for small events otherwise COMMENT IT !!!!
     ...
     //   Prog_ID for defining particle type,, 
      ...
      ForwJet_sorting_pT_based_After_Cleaning(UseSortedJets + Filling_at_Preselection); 

      // Whether you sort or not this line happens
      n_forwjet = forwjet_sort ;
      n_jet = jet_sort ;
      ...
      Lepton_Scale_Factor_ID  =  1.0 ;  // KEEPING LEPTON SCALE ID FACTOR SAME AS OTHER EVENT FACTORS, UNTILL CALCULATED     

      btag_weight  =  1.0 ;  // KEEPING LEPTON SCALE ID FACTOR SAME AS OTHER EVENT FACTORS, UNTILL CALCULATED     
      ...
      //Here for Control Region we are using Pre-Selection definition of ST as in 
      //        Scalar_Sum_pT_Function( Channel) ; 

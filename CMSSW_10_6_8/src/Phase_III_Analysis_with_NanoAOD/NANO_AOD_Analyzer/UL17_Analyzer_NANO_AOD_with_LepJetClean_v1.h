...
// Tue Dec 15 22:50:10 2020 by ROOT version 6.14/06       //
// from TTree Events/Events                               // 
// found on file: Lepton_clean_Test.root                  //
////////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           Jet_genJetIdx[31];   //[nJet]
   Int_t           Jet_hadronFlavour[31];   //[nJet]
   Int_t           Jet_partonFlavour[31];   //[nJet]
   ...
   Float_t         Jet_pt_raw[31];   //[nJet]
   Float_t         Jet_mass_raw[31];   //[nJet]
   Float_t         Jet_eta_raw[31];   //[nJet]
   Float_t         Jet_phi_raw[31];   //[nJet]
   Float_t         Jet_pt_clean[31];   //[nJet]
   Float_t         Jet_mass_clean[31];   //[nJet]
   Float_t         Jet_eta_clean[31];   //[nJet]
   Float_t         Jet_phi_clean[31];   //[nJet]
   Float_t         Jet_pt_nom[31];   //[nJet]
   Float_t         Jet_mass_nom[31];   //[nJet]
   Float_t         Jet_corr_JEC[31];   //[nJet]
   Float_t         Jet_corr_JER[31];   //[nJet]
   Float_t         Jet_corr_JMS[31];   //[nJet]
   Float_t         Jet_corr_JMR[31];   //[nJet]
   Float_t         Jet_msoftdrop_tau21DDT_nom[31];   //[nJet]
...
//////////////////////////////////////////////////////////////
   ...
   virtual void     Loop(TString OutputFileName, TString RunORTest, TString LeptonIsolation , TString Higgs_WP);
...
void UL17_Analyzer_NANO_AOD_with_LepJetClean::Init(TTree *tree)
{

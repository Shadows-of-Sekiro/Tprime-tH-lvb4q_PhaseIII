...
// Mon Nov 23 16:44:30 2020 by ROOT version 6.14/06
// from TTree Events/Events
// found on file: ../NANOAOD/TTbar/test.root
//////////////////////////////////////////////////////////

#ifndef MC_Analyzer_NANO_AOD_h
#define MC_Analyzer_NANO_AOD_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   UInt_t          nGenPart;
   Float_t         GenPart_eta[166];   //[nGenPart]
   Float_t         GenPart_mass[166];   //[nGenPart]
   Float_t         GenPart_phi[166];   //[nGenPart]
   Float_t         GenPart_pt[166];   //[nGenPart]
   Int_t           GenPart_genPartIdxMother[166];   //[nGenPart]
   Int_t           GenPart_pdgId[166];   //[nGenPart]
   Int_t           GenPart_status[166];   //[nGenPart]
   Int_t           GenPart_statusFlags[166];   //[nGenPart]
   ...
   Float_t         TkMET_sumEt;
   UInt_t          nTrigObj;
   Float_t         TrigObj_pt[39];   //[nTrigObj]
   Float_t         TrigObj_eta[39];   //[nTrigObj]
   Float_t         TrigObj_phi[39];   //[nTrigObj]
   Float_t         TrigObj_l1pt[39];   //[nTrigObj]
   Float_t         TrigObj_l1pt_2[39];   //[nTrigObj]
   Float_t         TrigObj_l2pt[39];   //[nTrigObj]
   Int_t           TrigObj_id[39];   //[nTrigObj]
   Int_t           TrigObj_l1iso[39];   //[nTrigObj]
   Int_t           TrigObj_l1charge[39];   //[nTrigObj]
   Int_t           TrigObj_filterBits[39];   //[nTrigObj]
   Int_t           genTtbarId;
   UInt_t          nOtherPV;
   ...
   Float_t         SelectedJet_softDrop_mass;
   Float_t         SelectedJet_tau42;
   Float_t         SelectedJet_tau41;
   Float_t         SelectedJet_tau32;
   Float_t         SelectedJet_tau21;
   Float_t         SelectedJet_tau21_ddt;
   Float_t         SelectedJet_tau21_ddt_retune;
   Float_t         SelectedJet_pt;
   Float_t         SelectedJet_eta;
   Float_t         SelectedJet_mass;
   Float_t         SelectedLepton_pt;
   Float_t         SelectedLepton_iso;
   Int_t           Wlep_type;
   Float_t         W_pt;
   Float_t         W_mass;
   Float_t         dr_LepJet;
   ...
   Float_t         dphi_WJet;
   Float_t         maxAK4CSV;
   Float_t         subMaxAK4CSV;
   Float_t         minJetMetDPhi;
   Float_t         HT_HEM1516;
   Int_t           genmatchedAK8;
   Int_t           genmatchedAK8Quarks;
   Int_t           genmatchedAK8Subjet;
   Int_t           AK8Subjet0isMoreMassive;
   Int_t           passedMETfilters;
   Float_t         lheweight;
   Float_t         puweight;
   Float_t         topweight;
   Float_t         btagweight;
   ...
   TBranch        *b_SelectedJet_softDrop_mass;   //!
   TBranch        *b_SelectedJet_tau42;   //!
   TBranch        *b_SelectedJet_tau41;   //!
   TBranch        *b_SelectedJet_tau32;   //!
   TBranch        *b_SelectedJet_tau21;   //!
   TBranch        *b_SelectedJet_tau21_ddt;   //!
   TBranch        *b_SelectedJet_tau21_ddt_retune;   //!
   TBranch        *b_SelectedJet_pt;   //!
   TBranch        *b_SelectedJet_eta;   //!
   TBranch        *b_SelectedJet_mass;   //!
   TBranch        *b_SelectedLepton_pt;   //!
   TBranch        *b_SelectedLepton_iso;   //!
   TBranch        *b_Wlep_type;   //!
   TBranch        *b_W_pt;   //!
   TBranch        *b_W_mass;   //!
   TBranch        *b_dr_LepJet;   //!
   ...
   TBranch        *b_dphi_WJet;   //!
   TBranch        *b_maxAK4CSV;   //!
   TBranch        *b_subMaxAK4CSV;   //!
   TBranch        *b_minJetMetDPhi;   //!
   TBranch        *b_HT_HEM1516;   //!
   TBranch        *b_genmatchedAK8;   //!
   TBranch        *b_genmatchedAK8Quarks;   //!
   TBranch        *b_genmatchedAK8Subjet;   //!
   TBranch        *b_AK8Subjet0isMoreMassive;   //!
   TBranch        *b_passedMETfilters;   //!
   TBranch        *b_lheweight;   //!
   TBranch        *b_puweight;   //!
   TBranch        *b_topweight;   //!
...
//  
   // MC_Analyzer_NANO_AOD(TTree *tree=0);
   MC_Analyzer_NANO_AOD(TString inputFile)   ;

   virtual ~MC_Analyzer_NANO_AOD();
...
#ifdef MC_Analyzer_NANO_AOD_cxx

/*
   MC_Analyzer_NANO_AOD::MC_Analyzer_NANO_AOD(TTree *tree) : fChain(0) 
   {
   // if parameter tree is not specified (or zero), connect the file
   // used to generate this class and read the Tree.
      if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../NANOAOD/TTbar/test.root");
         if (!f || !f->IsOpen()) {
            f = new TFile("../NANOAOD/TTbar/test.root");
      }
...
MC_Analyzer_NANO_AOD::MC_Analyzer_NANO_AOD(TString inputFile) {
...
MC_Analyzer_NANO_AOD::~MC_Analyzer_NANO_AOD()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MC_Analyzer_NANO_AOD::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MC_Analyzer_NANO_AOD::LoadTree(Long64_t entry)
{
...
void MC_Analyzer_NANO_AOD::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("SelectedJet_softDrop_mass", &SelectedJet_softDrop_mass, &b_SelectedJet_softDrop_mass);
   fChain->SetBranchAddress("SelectedJet_tau42", &SelectedJet_tau42, &b_SelectedJet_tau42);
   fChain->SetBranchAddress("SelectedJet_tau41", &SelectedJet_tau41, &b_SelectedJet_tau41);
   fChain->SetBranchAddress("SelectedJet_tau32", &SelectedJet_tau32, &b_SelectedJet_tau32);
   fChain->SetBranchAddress("SelectedJet_tau21", &SelectedJet_tau21, &b_SelectedJet_tau21);
   fChain->SetBranchAddress("SelectedJet_tau21_ddt", &SelectedJet_tau21_ddt, &b_SelectedJet_tau21_ddt);
   fChain->SetBranchAddress("SelectedJet_tau21_ddt_retune", &SelectedJet_tau21_ddt_retune, &b_SelectedJet_tau21_ddt_retune);
   fChain->SetBranchAddress("SelectedJet_pt", &SelectedJet_pt, &b_SelectedJet_pt);
   fChain->SetBranchAddress("SelectedJet_eta", &SelectedJet_eta, &b_SelectedJet_eta);
   fChain->SetBranchAddress("SelectedJet_mass", &SelectedJet_mass, &b_SelectedJet_mass);
   fChain->SetBranchAddress("SelectedLepton_pt", &SelectedLepton_pt, &b_SelectedLepton_pt);
   fChain->SetBranchAddress("SelectedLepton_iso", &SelectedLepton_iso, &b_SelectedLepton_iso);
   fChain->SetBranchAddress("Wlep_type", &Wlep_type, &b_Wlep_type);
   ...
   fChain->SetBranchAddress("dphi_WJet", &dphi_WJet, &b_dphi_WJet);
   fChain->SetBranchAddress("maxAK4CSV", &maxAK4CSV, &b_maxAK4CSV);
   fChain->SetBranchAddress("subMaxAK4CSV", &subMaxAK4CSV, &b_subMaxAK4CSV);
   fChain->SetBranchAddress("minJetMetDPhi", &minJetMetDPhi, &b_minJetMetDPhi);
   fChain->SetBranchAddress("HT_HEM1516", &HT_HEM1516, &b_HT_HEM1516);
   fChain->SetBranchAddress("genmatchedAK8", &genmatchedAK8, &b_genmatchedAK8);
   fChain->SetBranchAddress("genmatchedAK8Quarks", &genmatchedAK8Quarks, &b_genmatchedAK8Quarks);
   fChain->SetBranchAddress("genmatchedAK8Subjet", &genmatchedAK8Subjet, &b_genmatchedAK8Subjet);
   fChain->SetBranchAddress("AK8Subjet0isMoreMassive", &AK8Subjet0isMoreMassive, &b_AK8Subjet0isMoreMassive);
   fChain->SetBranchAddress("passedMETfilters", &passedMETfilters, &b_passedMETfilters);
...
Bool_t MC_Analyzer_NANO_AOD::Notify()
{
...
void MC_Analyzer_NANO_AOD::Show(Long64_t entry)
{
...
Int_t MC_Analyzer_NANO_AOD::Cut(Long64_t entry)
{
...
#endif // #ifdef MC_Analyzer_NANO_AOD_cxx
